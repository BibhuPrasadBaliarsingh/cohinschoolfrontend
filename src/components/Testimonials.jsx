...
export default function Testimonials() {
  ...
  return (
    <section className="py-12 lg:py-16 bg-gradient-to-b from-slate-900 via-navy-950 to-slate-900 text-white relative overflow-hidden border-t border-gold-500/20">
